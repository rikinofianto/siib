...
<div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading">Halaman Barang<br>
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="panel panel-default">
                             ...
                             <a href="index.php?act=tambah_barang" ><button type="submit" class="btn btn-primary">Tambah Barang</button></a>
                              <div class="pull-right search"><input type="text" placeholder="Cari Barang" class="form-kontrol">
