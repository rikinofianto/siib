...
$ruang = !empty($_POST['ruangan']) ? $_POST['ruangan'] : '';
if (!empty($ruang)) {
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="col-lg-3">
                                    <form method="post" action="index.php?act=barang" id="id-ruangan">
                                        <select class="form-control" name="ruangan" id="ruangan">
                                            <option>--Pilih Ruang--</option>
                                            <option value="1">Mushola</option>
                                            <option value="2">Kelas 1</option>
                                            <option value="3">Kelas 2</option>
                                            <option value="4">Kelas 3</option>
                                            <option value="5">Kelas 4</option>
                                            <option value="6">Kelas 5</option>
                                            <option value="7">Kelas 6</option>
                                            <option value="8">Perpustakaan</option>
                                            <option value="9">Kantor Guru</option>
                                            <option value="10">Alat-alat Olahraga</option>
                                        </select>
                                    </form>
                                </div>
                                <div class="col-lg-2">
                                    <a href="/export/print_pdf_barang.php?act=export&ruang=<?=$ruang;?>" class="btn btn-default">Export</a>
                                </div>
                                <div class="col-lg-5">
